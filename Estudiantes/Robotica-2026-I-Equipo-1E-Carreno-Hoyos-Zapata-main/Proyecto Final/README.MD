...
- **Fotografía de la Celda Física Real**:
  ...
  ![Celda Física Ensamblada](Imagenes/P.png)
...
- **Diagrama de la Máquina de Estados**![Diagrama de Flujo del Proceso Global](Imagenes/BB.jpeg).
- **Plano de Planta y Distribución de la Celda** ![Arquitectura ROS 2](Imagenes/A.jpeg).
- **Arquitectura de Nodos y Tópicos ROS 2** ![Plano de Planta de la Celda](Imagenes/CC.jpeg).
